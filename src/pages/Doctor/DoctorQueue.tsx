...
export default function DoctorQueue() {
  const { queueEntries, currentDoctor, updateQueueEntry, fetchQueue } = useClinic();
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="self-start flex items-center gap-2 px-6 py-3 bg-linear-to-r from-emerald-600 to-teal-500 text-white rounded-xl hover:shadow-lg transition-all"
